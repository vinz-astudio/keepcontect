...
export const S1_CONTRACTS = [
  ...
  {
    id: 'ADR0039-SPECIAL-01',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'red',
    route: 'S3',
    invariant: 'Private Special Attention subscription exists',
  },
  {
    id: 'ADR0039-SPECIAL-02',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'red',
    route: 'S3',
    invariant: 'Special Attention has an explicit default-off setter',
  },
  {
    id: 'ADR0039-SPECIAL-03',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'red',
    route: 'S3',
    invariant: 'Special Attention subscriber identity is private',
  },
  {
    id: 'ADR0039-SPECIAL-04',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'red',
    route: 'S3',
    invariant: 'Special Attention grants no operational authority',
  },
  {
    id: 'ADR0039-SPECIAL-05',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'red',
    route: 'S3',
    invariant: 'Only active relationships are eligible for Special Attention notices',
  },
  {
    id: 'ADR0039-GUARDIAN-01',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'pass',
    route: 'S2',
    invariant: 'Guardian cannot insert Ward activity through Data API',
  },
  {
    id: 'ADR0039-GUARDIAN-02',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'pass',
    route: 'S2',
    invariant: 'Guardianship supports pending active and revoked states',
  },
  {
    id: 'ADR0039-GUARDIAN-03',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'pass',
    route: 'S2',
    invariant: 'Guardianship relationship is visible to both parties',
  },
  {
    id: 'ADR0039-GUARDIAN-04',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'pass',
    route: 'S2',
    invariant: 'Guardian cannot alter Ward credentials, consent, or account deletion',
  },
  {
    id: 'ADR0039-GUARDIAN-05',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'pass',
    route: 'S2',
    invariant: 'External confirmation cannot create Ward behavior evidence',
  },
  {
    id: 'ADR0039-GUARDIAN-06',
    pack: 'care-authority',
    layer: 'pgtap',
    file: 'supabase/tests/s1_care_authority_contract.sql',
    expected: 'pass',
