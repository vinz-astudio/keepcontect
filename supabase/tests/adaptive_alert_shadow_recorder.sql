...
SELECT results_eq(
  $$
    SELECT fn, encode(extensions.digest(pg_get_functiondef(oid), 'sha256'), 'hex')
    FROM (
      VALUES
  ...
  $$,
  $$ VALUES
    ('process_escalations'::text, 'cacb14d4490f5cf256d4ca2d075fcd5c0061b8eb8cee72af86df2311c1dfe3d1'::text),
    ('silence_threshold'::text, '1907d59473d274d46a0e8e0b9ce8027037b4494b0dddf073cb46abf67db92e21'::text)
  $$,
